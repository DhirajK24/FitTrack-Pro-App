...
void main() async {
  ...
  Hive.registerAdapter(EnhancedWorkoutModelAdapter());
  Hive.registerAdapter(EnhancedExerciseModelAdapter());
  Hive.registerAdapter(EnhancedSetModelAdapter());
  Hive.registerAdapter(WorkoutStatusAdapter());
  Hive.registerAdapter(EnhancedWaterLogModelAdapter());
  Hive.registerAdapter(WaterSourceAdapter());
  Hive.registerAdapter(WaterGoalModelAdapter());
  Hive.registerAdapter(EnhancedSleepLogModelAdapter());
  Hive.registerAdapter(SleepQualityAdapter());
  Hive.registerAdapter(SleepGoalModelAdapter());
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => EnhancedWorkoutProvider(null)),
        ChangeNotifierProvider(create: (_) => EnhancedWaterProvider(null)),
        ChangeNotifierProvider(create: (_) => EnhancedSleepProvider(null)),
